      ...
      <div class="container mx-auto py-12 px-8 md:px-0 lg:w-2/3 xl:max-w-3xl space-y-16">
        <section id="snippets">
          <div id="writings-title" class="flex justify-between items-baseline mb-6">
            <h2 class="text-2xl font-semibold">Tulisan Blog</h2>
            <input class="w-1/2 h-6 border rounded-sm border-gray-400 text-center text-xs" name="search" placeholder="Cari Kata Kunci...">
          </div>
