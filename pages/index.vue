      ...
      <div class="container mx-auto py-12 px-8 md:px-0 lg:w-2/3 xl:max-w-3xl space-y-16">
        <section id="snippets">
          ...
          <div class="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
            <nuxt-link :to="snippet.path" v-for="(snippet, i) in snippets" :key="i" class="md:w-1/3 h-32 bg-white shadow-md hover:shadow-lg border rounded-lg inline-block flex items-center justify-center">
        ...
        <section id="writings">
          ...
          <div class="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
            <div v-for="(post, i) in posts" :key="i" class="md:w-1/3 h-48 bg-white shadow-md hover:shadow-lg border rounded-lg inline-block flex items-center justify-center">
              <div class="text-center p-4">
